...
<html
  ...
  <head>
    <title>Formulir periode - super admin</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Formulir periode</h4>
                      ...
                      <div class="card-body">
                        <form class="needs-validation" novalidate>
                          <div class="mb-3">
                            ...
                            <div class="invalid-feedback">Silahkan masukan periode</div>
                          </div>
                          <div class="row">
                            <div class="col-12">

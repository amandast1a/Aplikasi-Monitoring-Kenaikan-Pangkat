                ...
                <div id="statistic" class="col-lg-12 mb-4 col-md-12">
                  ...
                  <div class="col-lg-12 mb-4 col-md-12">
                    <div class="card tour-card">
                      <h5 class="card-header">Perkenalan</h5>
                      <div class="card-body">
                        <button class="btn btn-primary" id="shepherd-example">Mulai Perkenalan</button>
                        <button type="button" data-bs-toggle="modal" data-bs-target="#fullscreenModal" class="btn btn-primary">Timeline Pengajuan Kenaikan Pangkat</button>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-12 mb-4 col-md-12">
                    ...
                    <div class="modal-dialog modal-fullscreen" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="modalFullTitle">Timeline Pengajuan Kenaikan Pangkat</h5>
                          <button
                            type="button"
                            class="btn-close"
                                ...
                                <ul class="timeline timeline-center mt-5">
                                  <li class="timeline-item">
                                    ...
                                    <div class="timeline-event card p-0" data-aos="fade-right">
                                      ...
                                      <div class="card-body">
                                        <p class="mb-2">
                                          Our main goal is to design a new mobile verifikator for our client. The customer wants a
                                          clean & flat design.
                                        </p>
                                  ...
                                  <li class="timeline-item">
                                    <span
                                      ...
                                      data-aos="zoom-in"
                                      data-aos-delay="200">
                                      <i class="ti ti-chart-donut-2 ti-sm"></i>
                                    </span>
                                    <div class="timeline-event card p-0" data-aos="fade-left">
                                      ...
                                      <div class="card-body">
                                        <div class="d-flex flex-sm-row flex-column">
                                          <img
                                            ...
                                            class="rounded me-3 mb-sm-0 mb-2"
                                            alt="doughnut"
                                            height="64"
                                            width="64" />
                                          <div>
                                            ...
                                            <p class="mb-2">
                                              I gaze longingly at the beautiful, perfect, plump donut. This is a delicately crafted

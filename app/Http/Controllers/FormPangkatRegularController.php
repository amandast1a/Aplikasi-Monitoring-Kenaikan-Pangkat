...
class FormPangkatRegularController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('application.crud-form-regular.table-regular', compact('notifications', 'user', 'unreadCount'));
    }
    ...
    public function create()
    {
        ...
        $notifications = Notification::where('user_id', $user->id)->where('read', false)->get();
        $unreadCount = $notifications->where('read', false)->count();
        return view('application.crud-form-regular.form-regular', compact('notifications', 'user', 'unreadCount'));
    }
    ...
    public function proses()
    {
        ...
        $notifications = Notification::where('user_id', $user->id)->where('read', false)->get();
        $unreadCount = $notifications->where('read', false)->count();
        return view('application.proses.teble-regular', compact('notifications', 'user', 'unreadCount'));
    }
